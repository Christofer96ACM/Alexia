<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="DashboardService.aspx.cs" Inherits="OneCommerce.Reportes.DashboardService" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

       <dx:ASPxDashboardViewer runat="server" ID="dashboardViewer1" Width="100%" Height="100%" DashboardId="idTablero"
        RegisterJQuery="True" DashboardXmlFile="Config/DashboardServicios.xml" OnDashboardLoading="dashboardViewer1_DashboardLoading" OnDataLoading="dashboardViewer1_DataLoading"  AllowExportDashboard="true" AllowExportDashboardItems="True">
    ...
    <script src="Config/jquery.rowspanizer.js"></script>
    <script>
        ...
        function MostrarFiltro(){
            if ($('.dx-dashboard-loading').length) {
                ...
                $('.dx-dashboard-title-text').html($('.dx-dashboard-title-text').html() + 'del ' + $('#ctl00_ctl00_ASPxSplitter1_Content_ContentSplitter_MainContent_hffechaInicio').val() + ' al ' + $('#ctl00_ctl00_ASPxSplitter1_Content_ContentSplitter_MainContent_hffechaFin').val());
                $('.dx-datagrid-table').rowspanizer({vertical_align: 'middle'});
