<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="DashboardCompras.aspx.cs" Inherits="OneCommerce.Reportes.DashboardCompras" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

 
    <dx:ASPxDashboardViewer runat="server" ID="dashboardViewer1" Width="100%" Height="100%" DashboardId="idTablero"
        RegisterJQuery="True" DashboardXmlFile="Config/DashboardCompras.xml" OnDashboardLoading="dashboardViewer1_DashboardLoading" OnDataLoading="dashboardViewer1_DataLoading" AllowExportDashboard="true" AllowExportDashboardItems="True">
