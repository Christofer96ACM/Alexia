...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxDashboardViewer runat="server" ID="dashboardViewer1" Width="100%" Height="100%" DashboardId="idTablero"  ExportOptions-PageLayout="Portrait"
    ...
    <script>
        ...
        function MostrarFiltro(){
            if ($('.dx-dashboard-loading').length) {
               ...
               // $(".dx-dashboard-export").parent().append("<div class='dx-dashboard-export exportar' title='Exportar' id='btnExportarDashBoard'></div>")
                ...
                //$('#btnExportarDashBoard').click(function (){
                //    html2canvas(document.querySelector('.dx-dashboard-container'), {
