<%@ Page Title="Factura Proveedor" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="CompraFactura.aspx.cs" Inherits="OneCommerce.Purchase.CompraFactura" %>
...
<script type="text/javascript" src="../Scripts/Purchase/CompraFactura.js"></script>
<script type="text/javascript" src="../Scripts/Purchase/CompraFactura2.js"></script>
...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity:"sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin:"anonymous">
    ...
    <dx:ASPxFormLayout runat="server" ID="frlMain" 
        ...
        <Items>
            <dx:LayoutGroup Caption="Factura Proveedor" GroupBoxStyle-Caption-Font-Size="X-Large"
                                                ...
                                                <dx:ASPxGridView ID="gdvinv1" runat="server" AutoGenerateColumns="False" Width="1022px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--<dx:GridViewDataTextColumn Caption="Moneda" FieldName="LastPurCur"
                                                            ShowInCustomizationForm="True" VisibleIndex="10" Width="40px">
    ...
    <dx:ASPxPopupControl ID="ppcOinvSearch" runat="server" 
            ClientInstanceName="ppcOinvSearch" FooterText=" " HeaderText="Buscar Documento de Compra" 
            PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" 
            RenderMode="Lightweight" ShowFooter="True" Width="800px" Modal="true"
            AllowDragging="True" PopupAnimationType="Fade">
            <ContentStyle>
                    ...
                    <tr>
                        <td>
                            <dx:ASPxGridView ID="gdvOdlnSearch" runat="server" Width="100%" 
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Nro. Orden" FieldName="NumAtCard" 
                                        ShowInCustomizationForm="True" VisibleIndex="0" Width="70px">
                                        <Settings AllowSort="False" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Fecha" FieldName="DocDate"
                                    ...
                                    <dx:GridViewDataTextColumn Caption="DiscSum" FieldName="DocNum" 
                                        ShowInCustomizationForm="True" Visible="false" VisibleIndex="12" Width="0px">
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                                <SettingsBehavior AllowSelectByRowClick="True" 
                            ...
                            <td colspan="3" style="width:360px">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td style="width:30px"></td>
                                            <td>
                                                <dx:ASPxTextBox ID="txtSalEfe3" runat="server" ClientInstanceName="txtSalEfe3" 
                                                    Width="100%" HorizontalAlign="Right" DisplayFormatString="n2">
                                                <%--<MaskSettings Mask="&lt;0..99999999&gt;.&lt;00..99&gt;" />--%>
                                                <ValidationSettings ErrorDisplayMode="None">
                                                    <ErrorFrameStyle>
                                ...
                                <fieldset>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:30px"></td>
                                            <td>
                                                <dx:ASPxTextBox ID="txtSalTar3" runat="server" ClientInstanceName="txtSalTar3" 
                                                    Width="100%" HorizontalAlign="Right" DisplayFormatString="n2">
                                                <%--<MaskSettings Mask="&lt;0..99999999&gt;.&lt;00..99&gt;" />--%>
                                                <ValidationSettings ErrorDisplayMode="None">
                                                    <ErrorFrameStyle>
                                ...
                                <table>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:30px"></td>
                                            <td>
                                                <dx:ASPxTextBox ID="txtCuentaTrans" runat="server" ClientInstanceName="txtCuentaTrans" 
                                                    Width="100%" Text="Banco de Crédito" ReadOnly="true">
                                                </dx:ASPxTextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:30px"></td>
                                            <td>
                                                <dx:ASPxTextBox ID="txtSalTrans3" runat="server" ClientInstanceName="txtSalTrans3" 
                                                    Width="100%" HorizontalAlign="Right" DisplayFormatString="n2">
                                                <%--<MaskSettings Mask="&lt;0..99999999&gt;.&lt;00..99&gt;" />--%>
                                                <ValidationSettings ErrorDisplayMode="None">
                                                    <ErrorFrameStyle>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:240px">
                                                <dx:ASPxTextBox ID="txtCrLicTradNum" runat="server" MaxLength="11"
                                                    ...
                                                    <ClientSideEvents  KeyUp="Key_CrLicTradNum"></ClientSideEvents>
