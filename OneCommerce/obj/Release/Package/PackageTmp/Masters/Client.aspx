<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Client.aspx.cs" Inherits="OneCommerce.Masters.Client"%>
...
<script type="text/javascript" src="../Scripts/Tools/JSClientes.js"></script>
...
<Style HorizontalAlign="Right" VerticalAlign="Middle" Font-Size="8pt">
                                                ...
                                                <dx:ASPxGridView ID="gvDirecciones" runat="server" AutoGenerateColumns="False" Width="800px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Calle/Direccion" ShowInCustomizationForm="True" 
                                                            VisibleIndex="2" Width="200px" FieldName="Street" ReadOnly="true">
                                                        ...
                                                        <dx:GridViewDataButtonEditColumn Caption="Urbanizacion" ShowInCustomizationForm="True" 
                                                            VisibleIndex="9" Width="100px" FieldName="Building" ReadOnly="true">
                                                            <PropertiesButtonEdit ClientInstanceName="Building">
                                                                <Buttons>
                                                                    <dx:EditButton ToolTip="Buscar Urbanizacion">
                                                                    </dx:EditButton>
                                                                </Buttons>
                                                                <Style Font-Size="8pt">
                                                                </Style>
                                                                <ClientSideEvents ButtonClick="Show_Urbanizacion" />
                                                            </PropertiesButtonEdit>
                                                            <EditCellStyle Font-Size="8pt">
                                                            </EditCellStyle>
                                                            <CellStyle VerticalAlign="Middle" ForeColor="Black">
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Codigo Urbanizacion" ShowInCustomizationForm="True" 
                                                            VisibleIndex="10" Width="0px" FieldName="GlblLocNum" ReadOnly="false">
                                                            <PropertiesTextEdit ClientInstanceName="GlblLocNum"
                                                                DisplayFormatInEditMode="true">    </PropertiesTextEdit>                                           
                                                            <EditCellStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Size="8pt">
                                                            </EditCellStyle>
                                                            <HeaderStyle CssClass="DisplayNone" />
                                                        ...
                                                        <dx:GridViewDataButtonEditColumn Caption="Zonas/Gabinete" ShowInCustomizationForm="True" 
                                                            VisibleIndex="11" Width="100px" FieldName="U_DXP_BIZ_ZONA" ReadOnly="true">
                                                            <PropertiesButtonEdit ClientInstanceName="U_DXP_BIZ_ZONA">
                                                                <Buttons>
                                                                    <dx:EditButton ToolTip="Buscar Gabinete">
                                                                    </dx:EditButton>
                                                                </Buttons>
                                                                <Style Font-Size="8pt">
                                                                </Style>
                                                                <ClientSideEvents ButtonClick="Show_Gabinete" />
                                                            </PropertiesButtonEdit>
                                                            <EditCellStyle Font-Size="8pt">
                                                            </EditCellStyle>
                                                            <CellStyle VerticalAlign="Middle" ForeColor="Black">
                                                        ...
                                                        <dx:GridViewDataCheckColumn VisibleIndex="13" UnboundType="String" Caption="Fiscal" FieldName="AdresType">
                                                            <PropertiesCheckEdit AllowGrayed="false" ValueChecked="B" ValueUnchecked="S" ValueType="System.String"></PropertiesCheckEdit>
                                                        </dx:GridViewDataCheckColumn>
                                                        <dx:GridViewDataCheckColumn VisibleIndex="14" UnboundType="String" Caption="Activo" FieldName="Active">
                                                            <PropertiesCheckEdit AllowGrayed="false" ValueChecked="Activo" ValueUnchecked="Inactivo" ValueType="System.String"
                                                                 ClientInstanceName="ActiveDirec"></PropertiesCheckEdit>
                                                        </dx:GridViewDataCheckColumn>
                                                        <dx:GridViewDataTextColumn Caption="Referencia" ShowInCustomizationForm="True" 
                                                            VisibleIndex="12" Width="100px" FieldName="StreetNo" ReadOnly="true">
                                                            <PropertiesTextEdit ClientInstanceName="StreetNo" 
                                                                DisplayFormatInEditMode="true" MaxLength="100">
                                                            </PropertiesTextEdit>
                                                            <EditCellStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Size="8pt">
                                                            </EditCellStyle>
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
    ...
    <dx:ASPxPopupControl ID="ppcGabineteSearch" runat="server" 
        ClientInstanceName="ppcGabineteSearch" FooterText=" " HeaderText="Buscar Gabinete" 
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" 
        RenderMode="Lightweight" ShowFooter="True" Width="500px" Modal="true"
        AllowDragging="True" PopupAnimationType="Fade">
        <ContentStyle>
        ...
        <ContentCollection>
            <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
                <table border="0" style="width:100%">
                    ...
                    <tr>
                        <td>
                            <dx:ASPxGridView ID="gdvGabinete" runat="server" Width="100%" 
                                AutoGenerateColumns="False" ClientInstanceName="gdvGabinete" 
                                KeyFieldName="Code" OnCustomCallback="gdvGabinete_CustomCallback" 
                                KeyboardSupport="True" OnDataBinding="gdvGabinete_DataBinding">
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Código" FieldName="Code" 
                                        ShowInCustomizationForm="True" SortIndex="0" SortOrder="Ascending" 
                                        VisibleIndex="0" Width="150px">
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Nombre" FieldName="Name" 
                                        ShowInCustomizationForm="True" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                                <SettingsBehavior AllowSelectByRowClick="True" 
                                    AllowSelectSingleRowOnly="True" />
                                <ClientSideEvents ColumnSorting="SetParName" RowDblClick="OkGabinete" EndCallback="EndGabineteSearch"/>
                                <Styles>
                                    <Row Font-Size="7pt">
                                    </Row>
                                </Styles>
                            ...
                            <table style="width:100%;" class="tablespace">
                                <tr>
                                    <td style="width:340px">
                                        &nbsp;</td>
                                    <td>
                                        <dx:ASPxButton ID="btnGabineteOk" runat="server" Text="Ok" Width="100%" 
                                            ClientInstanceName="btnGabineteOk" AutoPostBack="False">
                                            <ClientSideEvents Click="OkGabinete" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td>
                                        <dx:ASPxButton ID="btnGabineteCancel" runat="server" Text="Cancelar" Width="100%" 
                                            ClientInstanceName="btnGabineteCancel" AutoPostBack="False">
                                            <ClientSideEvents Click="CancelGabinete" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
