<%@ Page Title="Documento de Anticipo" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="FacturaAnticipo.aspx.cs" Inherits="OneCommerce.Sales.FacturaAnticipo" %>
...
<script type="text/javascript" src="../Scripts/Sales/ARAnticipo.js"></script>
<script type="text/javascript" src="../Scripts/Sales/ARAnticipo2.js"></script>
...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity:"sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin:"anonymous">
    ...
    <dx:ASPxFormLayout runat="server" ID="frlMain" 
        ...
        <Items>
            <dx:LayoutGroup Caption="Documento de Anticipo" GroupBoxStyle-Caption-Font-Size="X-Large"
                                            ...
                                            <td colspan="2" style="width:500px">
                                                 <table style="width:500px" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td style="width:200px">
                                                            <dx:ASPxTextBox ID="txtGuiaRelacionada" runat="server" Width="200px"
                                                                ClientInstanceName="txtGuiaRelacionada" ReadOnly="true">
                                                                <ReadOnlyStyle Font-Bold="true"></ReadOnlyStyle>
                                                            </dx:ASPxTextBox>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width:80px">
                                                                <dx:ASPxTextBox ID="txtDiscPrcntTotal" runat="server" ClientInstanceName="txtDiscPrcntTotal" 
                                                                    HorizontalAlign="Right" Width="80px" Text="100.00" Font-Bold="true">
                                                                   <%--<MaskSettings Mask="&lt;0..999&gt;.&lt;00..999&gt;" />   --%>                                                                
                                                                    <ValidationSettings ErrorDisplayMode="None">
                                                                        <ErrorFrameStyle>
                                                                            <Paddings Padding="0px" />
                                                            ...
                                                            <td style="text-align:left;width:117px">
                                                                <dx:ASPxTextBox ID="txtDiscSum" runat="server" ClientInstanceName="txtDiscSum" 
                                                                    HorizontalAlign="Right" Width="117px" DisplayFormatString="c2" ReadOnly="false">
                                                                    <ReadOnlyStyle Font-Bold="true"></ReadOnlyStyle>
                                                                    <ClientSideEvents KeyUp="Set_Porcent"/>
                                                                </dx:ASPxTextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:200px">
                                            <dx:ASPxTextBox ID="txtQuantityKit" runat="server" Width="100%" 
                                                ClientInstanceName="txtQuantityKit" DisplayFormatString="f0" Visible="false">
                            ...
                            <td>
                                <dx:ASPxGridView ID="gdvOinvSearch" runat="server" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="DpmPrcnt" FieldName="DpmPrcnt" 
                                ...
                                <table class="tablespace" style="width:100%">
                                    <tr>
                                        <td style="width:105px">
                                            Rango Fechas:</td>
                                        <td style="width:130px">
                                            <dx:ASPxDateEdit ID="dteoqDateIn" runat="server" Width="130px" 
                                                ClientInstanceName="dteoqDateIn">
                                            </dx:ASPxDateEdit>
                                        </td>
                                        <td style="width:130px">
                                            <dx:ASPxDateEdit ID="dteoqDateFi" runat="server" Width="130px" 
                                                ClientInstanceName="dteoqDateFi">
                                            </dx:ASPxDateEdit>
                                        </td>
                                        <td style="width:5px">
                                        </td>
                                        <td style="width:130px">
                                            Nro. Orden:</td>
                                        <td style="width:170px">
                                            <dx:ASPxTextBox ID="txtoqDocNum" runat="server" 
                                                ClientInstanceName="txtoqDocNum" Width="170px">
                                            </dx:ASPxTextBox>
                                        </td>
                                        <td style="width:50px">
