...
function Get_InitialData() {
    ...
    {
        type: "POST",
        url: "../Sales/Oferta.aspx/Get_InitialData",
        data: '{"socied":"' + socied + '"}',
        contentType: "application/json; charset=uft-8",
        dataType: "json",
        success: function (result) {
...
function Set_InitialData(result) {
    ...
    _rs.forEach(function (item) {
        cbbListNum.AddItem(item.Name, item.Code);
        if (item.Dfault === 1) {
            _vld[7] = item.Code;
        }
    });
...
function OkProduct() {
    ...
    if (rowc === 0) {
        ...
        gdvProductSearch.GetRowValues(gdvProductSearch.GetFocusedRowIndex(), "ItemCode;ItemName;OnHand;PriceBefDi;DiscPrcnt;Price;PriceVat;NumInSale;IssueMthd", OnGetRowValuesProduct);
    }
}
...
function Set_SubTotal() {
    ...
    if (cbbDocCur.GetValue().toString() === "USD") {
        txtLineSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(_sbt.toFixed(4)));
    }
    else if (cbbDocCur.GetValue().toString() === "EUR") {
        txtLineSum.SetText(new Intl.NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(_sbt.toFixed(4)));
    }
    else {
        txtLineSum.SetText(_sbt.toFixed(4));
    }
    Get_Totals();
}
function Get_Totals() {
...
//function Set_SubTotal() {//alert("settotal");
//    var _sbt = parseFloat(gdvrdr1.cpSubTotal);
//    if (cbbDocCur.GetValue().toString() === "USD") {
//        txtLineSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(_sbt.toFixed(4)));
//    }
...
//    var _sdt = (_sid);
//    var _imp = ((_sid * parseFloat(18.00)) / 100);
//    var _tot = (_sid + parseFloat(_imp.toFixed(4)));
    
//    Get_Totals();
//    if (cbbDocCur.GetValue().toString() === "EUR") {
//        txtLineSum.SetText(new Intl.NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(_sbt.toFixed(4)));
//        txtVatSum.SetText(new Intl.NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(_imp.toFixed(4)));
//        txtDocTotal.SetText(new Intl.NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(_tot.toFixed(4)));
//    }
//    else if (cbbDocCur.GetValue().toString() === "USD") {
//        var x = _sbt;
//        var y = x - parseFloat(txtDiscSum.GetValue());
//        var z = y * 0.18;
//        var r = x + z;
//        //alert(x + ":" + y + ":" + z + ":" + r + ":" + txtDiscSum.GetValue());
//        txtLineSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(x.toFixed(4)));
//        txtVatSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(z.toFixed(4)));
//        txtDocTotal.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(r.toFixed(4)));
//    }
    
//    else {
//        txtLineSum.SetText(_sbt.toFixed(4));
//        txtVatSum.SetText(_imp.toFixed(4));
//        txtDocTotal.SetText(_tot.toFixed(4));
//    }
//}
//function Get_Totals() {
...
//    var _sdt = _sbt;
//    var _imp = ((_sdt * parseFloat(18)) / 100);
//    var _tot = (_sdt + parseFloat(_imp.toFixed(4)));
//    if (cbbDocCur.GetValue().toString() == "USD") {
//        var x = parseFloat(gdvrdr1.cpSubTotal);
//        var y = x - parseFloat(txtDiscSum.GetValue());
//        var z = y * 0.18;
//        var r = x + z;
//        //alert("gettotal");
//        //alert(x + ":" + y + ":" + z + ":" + r + ":" + txtDiscSum.GetValue());
//        //alert(_sbt + ":" + _dst + ":" + _sid + ":" + _imp + ":" + _tot);
//        txtVatSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(z));
//        txtDocTotal.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(r));
//    }
//    else if (cbbDocCur.GetValue().toString() == "EUR") {
//        txtVatSum.SetText(new Intl.NumberFormat("de-DE", {style: "currency", currency: "EUR"}).format(_imp.toFixed(4)));
//        txtDocTotal.SetText(new Intl.NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(_tot.toFixed(4)));
...
//    var _dst = (_sbt * _dsp) / 100;
//    if (cbbDocCur.GetValue().toString() == "USD") {
//        txtDiscSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(_sbt.toFixed(4)));
//    }
//    else if (cbbDocCur.GetValue().toString() == "EUR") {
//        txtDiscSum.SetText(new Intl.NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(_dst));
//    } else {
...
//    if (cbbDocCur.GetValue().toString() == "USD") {
//        var x = _sbt;
//        var y = x - parseFloat(txtDiscSum.GetValue().toString().substr(1));
//        var z = y * 0.18;
//        var r = x + z;
//        //txtLineSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(x));
//        txtVatSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(z));
//        txtDocTotal.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(r));
//    }
//    else if (cbbDocCur.GetValue().toString() == "EUR") {
...
function Set_Operation(s, e) {
    ...
    if (e.item.name === "Save" && e.item.GetText() === "Crear") {
                ...
                if (cbeSalesPerson.GetText() == "") {
                    alert("¡Ingresar Vendedor Asignado!");
                }
...
function Modify() {
    //if (_vld[6] !== "BT") {
        ...
        if (_sw) {
            var result = confirm("Desea modificar La Oferta?");
            if (result) {
...
// CANCELAR
function Cancel() {
    var result = confirm("¿Desea cancelar la Oferta de Venta?");
    if (result) {
...
function OnGetRowValuesOrdr(values) {
            ...
            cbbPersonContact.PerformCallback("INICIAR:" + values[5]);
            ...
            if (hdfTemp.Get("Currency") == "SOL") {
                ...
                txtDiscPrcntTotal.SetText(values[16]);
                txtDiscSum.SetText(new Intl.NumberFormat("en-US", { style: "currency", currency: "USD" }).format(values[17].toFixed(4)));
            }
            else if (hdfTemp.Get("Currency") == "EUR") {
                txtDiscPrcntTotal.SetText(values[16]);
                txtDiscSum.SetText(new Intl.NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(values[17].toFixed(4)));
            }
...
function ShowOqutSearch() {
    if (isNullOrWhiteSpace(txtCardCode.GetText())) {
        ...
        alert("Crear nueva orden de venta.");
    }
    else {
...
function OkOqut() {
    ...
    if (rowc === 0) {
        ...
        gdvOqutSearch.GetRowValues(gdvOqutSearch.GetFocusedRowIndex(), "DocEntry", OnGetRowValuesOqut);
    }
}
function OnGetRowValuesOqut(values) {
    gdvrdr1.PerformCallback("OQUT;" + values);
    gdvOqutSearch.SetFocusedRowIndex(-1);
    ppcOqutSearch.Hide();
}
function CancelOqut() {
...
function PrintTicket() {
    try {
        ...
        //DETAIL
        for (var i = 0; i < gdvrdr1.GetVisibleRowsOnPage(); i++) {
            var _pricediscount = (" S/. " + parseFloat(gdvrdr1.GetRow(i).cells[7].innerText.replace("S/. ", "").replace(",", "")).toFixed(2));
