<%@ Page Title="Nota de Crédito" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="CreditNote.aspx.cs" Inherits="OneCommerce.Sales.CreditNote" %>
...
<script type="text/javascript" src="../Scripts/Sales/CreditNote.js"></script>
    <dx:ASPxFormLayout runat="server" ID="frlMain" 
        RequiredMarkDisplayMode="None" EnableViewState="False">
        <Items>
            <dx:LayoutGroup Caption="Nota de Crédito" GroupBoxStyle-Caption-Font-Size="X-Large"
                                    ...
                                    <table class="tablespace">
                                            ...
                                            <td colspan="2" style="width:500px">
                                                <table style="width:500px" border="0" cellpadding:"0" cellspacing:"0">
                                                    <tr>
                                                        ...
                                                        <td style="width:200px">
                                                            <dx:ASPxComboBox ID="cbbMotivoG" runat="server" Width="200px" EnableSynchronization="False"
                                                                ClientInstanceName="cbbMotivoG" SelectedIndex="0" Visible="true" >
                                                            </dx:ASPxComboBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="width:500px">
					                            <table style="width:500px" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="width:166px; float:left;">
                                                            <table style="width:166px">
                                                                <tr>
                                                                    <td>
                                                                    <dx:ASPxTextBox ID="TipoDoc" runat="server" Width="99px" EnableSynchronization="False"
                                                                    ClientInstanceName="TipoDoc">
                                                                    </dx:ASPxTextBox>
                                                                    </td><td>
                                                                    <dx:ASPxTextBox ID="lblTipoDoc" runat="server" Width="65px" EnableSynchronization="False"
                                                                        ClientInstanceName="lblTipoDoc" Text="Tipo Doc." ReadOnly="true">
                                                                    </dx:ASPxTextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td style="width:166px; float:left;">
                                                            <table style="width:166px">
                                                                <tr>
                                                                    <td>
                                                                    <dx:ASPxTextBox ID="SerieDoc" runat="server" EnableSynchronization="False"
                                                                        ClientInstanceName="SerieDoc" Width="99px">
                                                                    </dx:ASPxTextBox>
                                                                    </td><td>
                                                                    <dx:ASPxTextBox ID="lblSerieDoc" runat="server" Width="65px" EnableSynchronization="False"
                                                                        ClientInstanceName="lblSerieDoc" Text="Serie Doc." ReadOnly="true">
                                                                    </dx:ASPxTextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td style="width:166px; float:left;">
                                                            <table style="width:166px">
                                                                <tr>
                                                                    <td>
                                                                    <dx:ASPxTextBox ID="CorrelativoDoc" runat="server" ClientInstanceName="CorrelativoDoc" 
                                                                        Width="99px" ReadOnly="false">
                                                                    </dx:ASPxTextBox>
                                                                                </td><td>
                                                                    <dx:ASPxTextBox ID="lblCorrelativoDoc" runat="server" Width="67px" EnableSynchronization="False"
                                                                        ClientInstanceName="lblCorrelativoDoc" Text="Nro. Doc." ReadOnly="true">
                                                                    </dx:ASPxTextBox>
                                                                     </td>
                                                                 </tr>
                                                              </table>
                            ...
                            <td>
                                <dx:ASPxGridView ID="gdvOrinSearch" runat="server" Width="100%" 
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="MotivoG" FieldName="U_DXP_FE_MOT_GEN" 
                                            ShowInCustomizationForm="True" Visible="false" VisibleIndex="23" Width="0px">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="U_BPP_MDTO" FieldName="U_BPP_MDTO" 
                                            ShowInCustomizationForm="True" Visible="false" VisibleIndex="24" Width="0px">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="U_BPP_MDSO" FieldName="U_BPP_MDSO" 
                                            ShowInCustomizationForm="True" Visible="false" VisibleIndex="25" Width="0px">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="U_BPP_MDCO" FieldName="U_BPP_MDCO" 
