<%@ Page Title="Documento de Venta" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="ARInvoice.aspx.cs" Inherits="OneCommerce.Sales.ARInvoice" %>
...
<script type="text/javascript" src="../Scripts/Sales/ARInvoice.js"></script>
<script type="text/javascript" src="../Scripts/Sales/ARInvoice2.js"></script>
                                        ...
                                        OnRowInserting="gvcontacto_RowInserting">
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Nombre" ShowInCustomizationForm="True" 
                                                            ...
                                                            <PropertiesTextEdit ClientInstanceName="txtNameContacto" DisplayFormatString="{0:c2}"
                                                                DisplayFormatInEditMode="true">
                                                            <Style HorizontalAlign="Right" VerticalAlign="Middle" Font-Size="8pt">
                                                            </Style>
                                                            </PropertiesTextEdit>
