<%@ Page Title="Guia de Remisión" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="DeliveryNote.aspx.cs" Inherits="OneCommerce.Sales.DeliveryNote" %>
...
<script type="text/javascript" src="../Scripts/Sales/DeliveryNote.js"></script>
    <dx:ASPxFormLayout runat="server" ID="frlMain" 
        RequiredMarkDisplayMode="None" EnableViewState="False">
        <Items>
            <dx:LayoutGroup Caption="Guia de Remision" GroupBoxStyle-Caption-Font-Size="X-Large"
                                    ...
                                    <table class="tablespace">
                                        ...
                                        <tr>
                                            <td style="width:160px">
                                                Motivo Traslado:</td>
                                            <td colspan="1" style="width:150px">
                                                <dx:ASPxComboBox ID="cbbMotTras" runat="server" Width="150px"
                                                    ClientInstanceName="cbbMotTras">
                                                </dx:ASPxComboBox>
                                            </td>
                                            <td style="width:350px">
                                                <table>
                                                    <tr>
                                                        <td style="width:150px; text-align:center">
                                                            Modo Traslado:</td>
                                                        <td style="width:200px">
                                                            <dx:ASPxComboBox ID="cbbModTras" runat="server" EnableSynchronization="False"
                                                                ClientInstanceName="cbbModTras" Width="200px" OnCallback="cbbPersonContact_Callback">
                                                            </dx:ASPxComboBox>
                                                        </td>
                                                    </tr>
                                                </table>
                            ...
                            <dx:ASPxGridView ID="gdvOrdrSearch" runat="server" Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Dirección" FieldName="ShipStreet" 
                                        ShowInCustomizationForm="True" Visible="true" VisibleIndex="17" Width="0px">
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                            ...
                            <td>
                                <dx:ASPxGridView ID="gdvodlnSearch" runat="server" Width="100%" 
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Dirección" FieldName="ShipStreet" 
                                            ShowInCustomizationForm="True" Visible="true" VisibleIndex="24" Width="0px">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="DocCur" FieldName="DocCur" 
                                        ...
                                        <dx:GridViewDataTextColumn Caption="U_DXP_FE_MOTIVO_TRAS" FieldName="U_DXP_FE_MOTIVO_TRAS" 
                                            ShowInCustomizationForm="True" Visible="false" VisibleIndex="28" Width="0px">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="U_DXP_FE_MODALIDTRAS" FieldName="U_DXP_FE_MODALIDTRAS" 
