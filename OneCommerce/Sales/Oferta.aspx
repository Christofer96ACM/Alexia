<%@ Page Title="Oferta de Venta" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Oferta.aspx.cs" Inherits="OneCommerce.Sales.Oferta" %>
...
<script type="text/javascript" src="../Scripts/Sales/Oferta.js" ></script>
 <style type="text/css">
    ...
    <dx:ASPxFormLayout runat="server" ID="frlMain" 
        ...
        <Items>
            <dx:LayoutGroup Caption="Oferta de Venta" GroupBoxStyle-Caption-Font-Size="X-Large"
    ...
    <dx:ASPxPopupControl ID="ppcOrdrSearch" runat="server" 
        ClientInstanceName="ppcOrdrSearch" FooterText=" " HeaderText="Buscar Oferta de Venta" 
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" 
        RenderMode="Lightweight" ShowFooter="True" Width="800px" Modal="true"
        AllowDragging="True" PopupAnimationType="Fade">
        <ContentStyle>
