<%@ Page Title="Orden de Venta" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="OrdenVenta.aspx.cs" Inherits="OneCommerce.Sales.OrdenVenta" %>
...
<script type="text/javascript" src="../Scripts/Sales/OrdenVenta.js"></script>
<style type="text/css">
    ...
    <dx:ASPxFormLayout runat="server" ID="frlMain" 
        ...
        <Items>
            <dx:LayoutGroup Caption="Orden de Venta" GroupBoxStyle-Caption-Font-Size="X-Large"
                                    ...
                                    <table class="tablespace">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:205px">
                                                            <dx:ASPxComboBox ID="cbbU_BIZ_CONTA" runat="server" EnableSynchronization="False"
                                                                ...
                                                                <Items>
                                                                    <dx:ListEditItem Text="Cliente" Value="C" />
                                                                                ...
                                                                                <dx:ASPxGridView ID="gdvrdr1" runat="server" AutoGenerateColumns="False"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Caption="Almacén" ShowInCustomizationForm="True" 
                                                                                            VisibleIndex="10" Width="0px" FieldName="WhsCode">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:150px" class="FormatLabel">
                                                Total Documento:</td>
                                            <td style="width:217px">
                                                <dx:ASPxTextBox ID="ASPxTextBox2" runat="server" HorizontalAlign="Right" Text="0" 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="bteClientSearch" runat="server" Text="Buscar" Width="100%" 
                                            ...
                                            <ClientSideEvents Click="Get_Client1" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <dx:ASPxGridView ID="gdvOrdrSearch" runat="server" Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Dirección" FieldName="ShipStreet" 
                                        ShowInCustomizationForm="True" Visible="true" VisibleIndex="20" Width="0px">
                                    </dx:GridViewDataTextColumn>
                        ...
                        <td>
                            <dx:ASPxGridView ID="gdvOqutSearch" runat="server" Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Dirección" FieldName="Address2" 
                                        ShowInCustomizationForm="True" Visible="true" VisibleIndex="14" Width="0px">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="GroupNum" FieldName="GroupNum" 
                                        ShowInCustomizationForm="True" Visible="false" VisibleIndex="15" Width="0px">
                                    </dx:GridViewDataTextColumn>
